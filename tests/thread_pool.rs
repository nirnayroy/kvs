...
fn spawn_counter<P: ThreadPool>(pool: P) -> Result<(), DBError>  {
...
fn spawn_panic_task<P: ThreadPool>() -> Result<(), DBError>  {
...
#[test]
fn naive_thread_pool_spawn_counter() -> Result<(), DBError>  {
    let pool = NaiveThreadPool::new(4)?;
    spawn_counter(pool)
}

// #[test]
// fn shared_queue_thread_pool_spawn_counter() -> Result<(), DBError>  {
//     let pool = SharedQueueThreadPool::new(4)?;
//     spawn_counter(pool)
// }

// #[test]
// fn rayon_thread_pool_spawn_counter() -> Result<(), DBError>  {
//     let pool = RayonThreadPool::new(4)?;
//     spawn_counter(pool)
// }

// #[test]
// fn shared_queue_thread_pool_panic_task() -> Result<(), DBError>  {
